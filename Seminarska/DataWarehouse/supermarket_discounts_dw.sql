...
-- Query za Nifi
SELECT f.update_id, f.product_id, f.old_price, f.new_price, t.date
FROM Fact_PriceUpdate f, Dim_time t
WHERE f.date_id = t.date_id AND t.date BETWEEN DATE_SUB('2024-09-16', INTERVAL 7 DAY) AND '2024-09-16';
